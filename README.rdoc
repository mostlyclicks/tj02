...
Pull it down:
git clone https://github.com/mostlyclicks/rc01.git name_of_your_app
...
1. Replace rc01 with name_of_your_app (~9 occurences, 4 files)
2. Replace Rc01 with NameOfYourApp (~11 occurences, 10 files)
