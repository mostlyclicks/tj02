...
Pull it down:
git clone https://github.com/mostlyclicks/ec02.git name_of_your_app
...
1. Replace ec02 with name_of_your_app (~9 occurences, 4 files)
2. Replace Ec02 with NameOfYourApp (~11 occurences, 10 files)
